...
export const START_NOW_COUNTERS: QuickCounterOption[] = [
  ...
  { label: '+5 min oral summary', actionType: 'English', metric: 'englishPoints', points: 5, contribution: 'English output' },
  { label: '+1 shadowing rep', actionType: 'English', metric: 'englishPoints', points: 5, contribution: 'Shadowing' },
