...
export const DEFAULT_TASK_TEMPLATES: TaskTemplate[] = [
  ...
  template('project-coding-block', 'Project / Vibe Coding', 'Project / Coding block', 'Vibe Coding', 'Focus', 'Medium', 120, 'daytime', 'high', 'Project / Coding block', 'Write one English sentence: Today I will fix/build/test...', 'Build or improve one real project.', ['Vibe Coding', 'project', 'coding']),
  template('deep-project-coding', 'Project / Vibe Coding', 'Deep project / coding block', 'Vibe Coding', 'Focus', 'High', 180, 'daytime', 'high', 'Deep Vibe Coding block', 'Define one concrete build outcome before opening the editor.', 'Long protected build time for substantial project work.', ['Vibe Coding', 'deep work', 'project', 'coding']),
  template('assessment-project-output', 'Project / Vibe Coding', 'Assessment / project output block', 'Study', 'Focus', 'High', 150, 'daytime', 'high', 'Assessment output block', 'Open the rubric and choose one output to complete.', 'Produce a concrete assessment or project deliverable.', ['assessment', 'project', 'output', 'deep work']),
  ...
  template('quiet-english-reading', 'Evening Quiet Input', 'Quiet English reading', 'English', 'Light', 'Low', 60, 'evening', 'low', 'Quiet reading block', 'Open one document and mark only New concept / Useful phrase.', 'Evening-friendly input without speaking.', ['English', 'reading', 'evening']),
  template('long-documentation-reading', 'Evening Quiet Input', 'Long documentation reading', 'AI', 'Light', 'Medium', 90, 'daytime', 'low', 'Long documentation block', 'Choose one documentation section and define what you need from it.', 'Long-form technical reading with light notes.', ['AI', 'Cyber', 'documentation', 'reading']),
