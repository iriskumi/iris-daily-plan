...
- Added a lightweight image settings modal with:
  ...
  - zoom, horizontal move, and vertical move sliders
  - remove image
  - cancel/save flow
...
5. Drag the preview image and adjust zoom / move sliders.
6. Change position and fit.
7. Save and refresh the app.
8. Reopen the modal, remove the image, save, and confirm the default illustration returns.
